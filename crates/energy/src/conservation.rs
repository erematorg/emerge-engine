...
pub fn initialize_energy_balance(
    ...
    query: Query<Entity, (With<forces::prelude::Mass>, Without<EnergyLedger>)>,
) {
    for entity in query.iter() {
        commands.entity(entity).insert(EnergyLedger::default());
    }
}
...
pub fn track_work_from_forces(
    ...
    mut query: Query<&mut EnergyLedger>,
    time: Res<Time>,
) {
