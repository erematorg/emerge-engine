...
**FROZEN** — no new features. MPM blocker is resolved: [emerge](https://github.com/erematorg/emerge)
is the physics engine and owns the particle temperature field (`Particle::temperature`).

What survives in LP: the energy ledger (conservation accounting, transaction tracking).
What migrates: thermodynamics computation will wire to `emerge::Particle::temperature` directly.
Wave/EM energy accounting remains partial and is low priority until emerge integration matures.
