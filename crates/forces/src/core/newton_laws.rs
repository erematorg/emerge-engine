...
/// transfers. Both entity and MPM events feed the same `EnergyLedger` ledger for unified tracking.
///
...
/// changes. Both entity and MPM events feed the same `EnergyLedger` ledger.
///
