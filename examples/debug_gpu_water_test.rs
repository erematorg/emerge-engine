// Isolate: does adding WATER (Fluid material) trigger the corruption?
//   cargo run --release --example debug_gpu_water_test --features gpu
...
fn main() {
    ...
    println!("GpuSimulation -- terrain (ground only) + water + creature, no hill");
    for i in 0..6 {
        solver.step_frame();
