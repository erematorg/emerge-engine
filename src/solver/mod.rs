...
pub use materials::{ConstitutiveModel, CorotatedMaterial, MaterialModel, MaterialParams, NeoHookeanMaterial, NewtonianFluidMaterial, SandMaterial, SnowMaterial};
